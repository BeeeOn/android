...
public enum ModuleType {
	...
	TYPE_ENUM(0x01, R.string.dev_enum_type, EnumValue.class),
	TYPE_TEMPERATURE(0x02, R.string.dev_temperature_type, TemperatureValue.class),
	TYPE_HUMIDITY(0x03, R.string.dev_temperature_type, HumidityValue.class),
	TYPE_PRESSURE(0x04, R.string.dev_pressure_type, PressureValue.class),
	...
	ModuleType(int id, int nameRes, Class<? extends BaseValue> valueClass) {
		mTypeId = id;
		mNameRes = nameRes;
