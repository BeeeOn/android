...
public class VentilationItem extends BaseItem {
    ...
    public VentilationItem(String name, String gateId,boolean active ,@Nullable double[] location, @Nullable String outsideAbsoluteModuleId, String inSideAbsoluteModuleId) {
