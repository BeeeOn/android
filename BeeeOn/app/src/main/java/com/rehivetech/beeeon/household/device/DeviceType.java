...
public enum DeviceType implements IIdentifier {
	...
	TYPE_6("6", "Regulator VPT LAN v1.0", R.string.devices__dev_regulator_vpt_lan, R.string.devices__manufacturer_thermona) {
		...
		public List<Module> createModules(Device device) {
			return Arrays.asList(
					new Module(device, "0", 0x01, null, R.string.devices__zone_1, R.string.devices__mod_boiler_operation_type, true, Arrays.asList(
							new Module.Rule(0, new int[] {1, 2, 3, 4, 5, 11, 12, 13}),
							new Module.Rule(1, new int[] {2, 4}),
							new Module.Rule(2, new int[] {2, 4}),
							new Module.Rule(3, new int[] {4})
					), Arrays.asList(
							new EnumValue.Item(0, "0", R.string.devices__val_boiler_operation_type_off),
							new EnumValue.Item(1, "1", R.string.devices__val_boiler_operation_type_room_regulator),
							new EnumValue.Item(2, "2", R.string.devices__val_boiler_operation_type_equiterm_regulator),
					...
					new Module(device, "3", 0x02, null, R.string.devices__zone_1, R.string.devices__mod_current_room_temperature, false, null, null),
					new Module(device, "4", 0x02, null, R.string.devices__zone_1, R.string.devices__mod_requested_water_temperature, true, null, new BaseValue.Constraints(50.0, 90.0, 1.0), null),
					new Module(device, "5", 0x02, null, R.string.devices__zone_1, R.string.devices__mod_current_water_temperature, false, null, null),
					...
					new Module(device, "12", 0x02, null, R.string.devices__zone_1, R.string.devices__frost_protection_water_temperature, true, null, new BaseValue.Constraints(25.0, 50.0, 0.5), null),
					new Module(device, "13", 0x02, null, R.string.devices__zone_1, R.string.devices__frost_protection_threshold, true, null, new BaseValue.Constraints(0.0, 15.0, 0.5), null),
					new Module(device, "14", 0x01, null, R.string.devices__zone_2, R.string.devices__mod_boiler_operation_type, true, Arrays.asList(
							new Module.Rule(0, new int[] {15, 16, 17, 18, 19, 25, 26, 27}),
							new Module.Rule(1, new int[] {16, 18}),
							new Module.Rule(2, new int[] {16, 18}),
							new Module.Rule(3, new int[] {18})
					), Arrays.asList(
							new EnumValue.Item(0, "0", R.string.devices__val_boiler_operation_type_off),
							new EnumValue.Item(1, "1", R.string.devices__val_boiler_operation_type_room_regulator),
							new EnumValue.Item(2, "2", R.string.devices__val_boiler_operation_type_equiterm_regulator),
					...
					new Module(device, "18", 0x02, null, R.string.devices__zone_2, R.string.devices__mod_requested_water_temperature, true, null, new BaseValue.Constraints(50.0, 90.0, 1.0), null),
					...
					new Module(device, "26", 0x02, null, R.string.devices__zone_2, R.string.devices__frost_protection_water_temperature, true, null, new BaseValue.Constraints(25.0, 50.0, 0.5), null),
					new Module(device, "27", 0x02, null, R.string.devices__zone_2, R.string.devices__frost_protection_threshold, true, null, new BaseValue.Constraints(0.0, 15.0, 0.5), null),
					new Module(device, "28", 0x01, null, R.string.devices__zone_3, R.string.devices__mod_boiler_operation_type, true, Arrays.asList(
							new Module.Rule(0, new int[] {29, 30, 31, 32, 33, 39, 40, 41}),
							new Module.Rule(1, new int[] {30, 32}),
							new Module.Rule(2, new int[] {30, 32}),
							new Module.Rule(3, new int[] {32})
					), Arrays.asList(
							new EnumValue.Item(0, "0", R.string.devices__val_boiler_operation_type_off),
							new EnumValue.Item(1, "1", R.string.devices__val_boiler_operation_type_room_regulator),
							new EnumValue.Item(2, "2", R.string.devices__val_boiler_operation_type_equiterm_regulator),
					...
					new Module(device, "32", 0x02, null, R.string.devices__zone_3, R.string.devices__mod_requested_water_temperature, true, null, new BaseValue.Constraints(50.0, 90.0, 1.0), null),
					...
					new Module(device, "40", 0x02, null, R.string.devices__zone_3, R.string.devices__frost_protection_water_temperature, true, null, new BaseValue.Constraints(25.0, 50.0, 0.5), null),
					new Module(device, "41", 0x02, null, R.string.devices__zone_3, R.string.devices__frost_protection_threshold, true, null, new BaseValue.Constraints(0.0, 15.0, 0.5), null),
					new Module(device, "42", 0x01, null, R.string.devices__zone_4, R.string.devices__mod_boiler_operation_type, true, Arrays.asList(
							new Module.Rule(0, new int[] {43, 44, 45, 46, 47, 53, 54, 55}),
							new Module.Rule(1, new int[] {44, 46}),
							new Module.Rule(2, new int[] {44, 46}),
							new Module.Rule(3, new int[] {46})
					), Arrays.asList(
							new EnumValue.Item(0, "0", R.string.devices__val_boiler_operation_type_off),
							new EnumValue.Item(1, "1", R.string.devices__val_boiler_operation_type_room_regulator),
							new EnumValue.Item(2, "2", R.string.devices__val_boiler_operation_type_equiterm_regulator),
					...
					new Module(device, "46", 0x02, null, R.string.devices__zone_4, R.string.devices__mod_requested_water_temperature, true, null, new BaseValue.Constraints(50.0, 90.0, 1.0), null),
					...
					new Module(device, "54", 0x02, null, R.string.devices__zone_4, R.string.devices__frost_protection_water_temperature, true, null, new BaseValue.Constraints(25.0, 50.0, 0.5), null),
					new Module(device, "55", 0x02, null, R.string.devices__zone_4, R.string.devices__frost_protection_threshold, true, null, new BaseValue.Constraints(0.0, 15.0, 0.5), null),
					...
					new Module(device, "61", 0x02, null, R.string.devices__boiler, R.string.devices__mod_current_boiler_performance, false, null, null),
	...
	public static final long DEVICES_DATE = 1444926926179l;
