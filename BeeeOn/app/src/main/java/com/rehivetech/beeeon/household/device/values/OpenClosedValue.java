...
public final class OpenClosedValue extends BooleanValue {
	...
	public OpenClosedValue() {
		...
		mItems.add(this.new Item(0, CLOSED, R.drawable.ic_val_win_closed_gray, R.string.dev_enum_value_closed, Color.RED));
		mItems.add(this.new Item(1, OPEN, R.drawable.ic_val_win_open_gray, R.string.dev_enum_value_open, Color.GREEN));
	}
