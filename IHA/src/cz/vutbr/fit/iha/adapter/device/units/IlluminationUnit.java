...
public enum IlluminationUnit implements IDeviceUnit {
	DEFAULT("-1", R.string.dev_illumination_unit, R.string.dev_illumination_unit);

	private final String mId;
	private final int mResUnitName;
	private final int mResUnitShortName;

	private IlluminationUnit(String id, int resUnitName, int resUnitShortName) {
		this.mId = id;
