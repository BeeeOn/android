...
public enum EmissionUnit implements IDeviceUnit {
	DEFAULT("-1", R.string.dev_emission_unit, R.string.dev_emission_unit);

	private final String mId;
	private final int mResUnitName;
	private final int mResUnitShortName;

	private EmissionUnit(String id, int resUnitName, int resUnitShortName) {
		this.mId = id;
