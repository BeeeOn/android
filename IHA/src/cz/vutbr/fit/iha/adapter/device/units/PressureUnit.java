...
public enum PressureUnit implements IDeviceUnit {
	DEFAULT("-1", R.string.dev_pressure_unit, R.string.dev_pressure_unit);

	private final String mId;
	private final int mResUnitName;
	private final int mResUnitShortName;

	private PressureUnit(String id, int resUnitName, int resUnitShortName) {
		this.mId = id;
